...
async def get_sitemap():
    ...
    static_pages = [
        ...
        {"loc": f"{base_url}/events?type=train", "priority": "0.85", "changefreq": "hourly"},
        {"loc": f"{base_url}/events?type=attraction", "priority": "0.85", "changefreq": "hourly"},
        {"loc": f"{base_url}/events?type=festival", "priority": "0.85", "changefreq": "hourly"},
        {"loc": f"{base_url}/events?type=f1", "priority": "0.85", "changefreq": "hourly"},
        {"loc": f"{base_url}/events?type=tennis", "priority": "0.85", "changefreq": "hourly"},
        ...
        {"loc": f"{base_url}/eurostar-tickets", "priority": "0.95", "changefreq": "daily"},
        {"loc": f"{base_url}/f1-monaco-grand-prix", "priority": "0.90", "changefreq": "daily"},
        {"loc": f"{base_url}/tomorrowland-2025", "priority": "0.90", "changefreq": "daily"},
        {"loc": f"{base_url}/disneyland-paris", "priority": "0.90", "changefreq": "daily"},
