...
async def get_sitemap():
    ...
    static_pages = [
        ...
        {"loc": f"{base_url}/f1-monaco-grand-prix", "priority": "0.95", "changefreq": "daily"},
        {"loc": f"{base_url}/tomorrowland-2025", "priority": "0.95", "changefreq": "daily"},
        {"loc": f"{base_url}/disneyland-paris", "priority": "0.95", "changefreq": "daily"},
