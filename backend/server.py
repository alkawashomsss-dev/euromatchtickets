...
async def _get_page_seo(path: str):
    ...
    STATIC_SEO = {
        ...
        "taylor-swift-london-tickets": {"title": "Buy Taylor Swift London Tickets 2026 | Wembley From \u20ac79", "desc": "Buy Taylor Swift Wembley 2026 tickets from \u20ac79. Multiple dates available. Almost sold out \u2014 40% cheaper than Ticketmaster. 100% Guarantee. Instant QR.", "image": "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=1200"},
