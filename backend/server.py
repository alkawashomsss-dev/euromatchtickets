...
async def _get_page_seo(path: str):
    ...
    STATIC_SEO = {
        ...
        "concerts-in-paris-2026": {"title": "Concerts in Paris 2026 \u2014 Full Schedule & Cheap Tickets | EuroMatchTickets", "desc": "Every confirmed 2026 Paris concert: Stade de France, La D\u00e9fense Arena, Accor Arena, Le Z\u00e9nith, L'Olympia. Live prices from \u20ac55, venue guides, notify list. Updated daily.", "image": "https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=1200"},
