      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            {item.price_low && <span className="text-emerald-600 text-xs font-medium">From &euro;{item.price_low}</span>}
          </div>
        </div>
      </div>
    </Link>
...
export const RelatedEventsSection = ({ slug, category, city }) => {
  ...
  return (
    <div className="border-t border-slate-200 pt-10 mt-10 space-y-8" data-testid="related-events-section">
      ...
      <Section title="You Might Also Like" icon={ChevronRight} iconColor="text-slate-500" items={similar_pages} />
