...
export const OfficialPartnerBadges = () => (
  <div className="flex flex-wrap items-center justify-center gap-6 py-6">
    <div className="flex items-center gap-2 bg-[#1e1e1e] border border-white/10 rounded-none px-4 py-2 shadow-sm">
...
export const TrustpilotWidget = ({ rating = 4.8, reviews = 2847 }) => (
  <div className="bg-[#1e1e1e] border border-white/10 rounded-none p-6 shadow-sm">
    ...
    <p className="text-sm text-slate-500">Based on <span className="text-white font-semibold">{reviews.toLocaleString()}</span> reviews</p>
  ...
  <div className="bg-[#1e1e1e] border border-white/10 rounded-none p-6 shadow-sm">
    <div className="flex items-center gap-3 mb-4">
      <div className="w-10 h-10 bg-slate-100 rounded-none flex items-center justify-center">
        <span className="text-xl font-bold text-slate-300">G</span>
      </div>
      <div>
        <div className="font-semibold text-white">Google Reviews</div>
  ...
  return (
    <div className="space-y-4">
      {reviews.map((review, idx) => (
        <div key={idx} className="bg-[#1e1e1e] border border-white/10 rounded-none p-5 hover:shadow-md transition-shadow">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {review.verified && (
                    <span className="flex items-center gap-1 text-xs text-emerald-600 bg-emerald-500/10 px-2 py-0.5 rounded-full border border-emerald-200">
          ...
          <div className="text-xs text-slate-400">Event: <span className="text-slate-300 font-medium">{review.event}</span></div>
        </div>
      ))}
    </div>
  );
  ...
  <section className="py-16 bg-[#15151e]">
    <div className="max-w-6xl mx-auto px-4">
      <div className="text-center mb-12">
        <h2 className="text-2xl font-bold text-white mb-2">Official Ticket Partner</h2>
      ...
      <div className="mt-12">
        <h3 className="text-xl font-bold text-white mb-6 text-center">What Our Customers Say</h3>
