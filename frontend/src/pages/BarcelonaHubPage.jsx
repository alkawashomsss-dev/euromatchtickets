...
const BarcelonaHubPage = () => {
  ...
  const reviewSchema = {
    ...
    "review": [
      { "@type": "Review", "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" }, "author": { "@type": "Person", "name": "Maria G." }, "reviewBody": "Camp Nou was magical! Got La Liga tickets for half the price of other sites. Amazing!", "datePublished": "2026-02-18" },
      { "@type": "Review", "reviewRating": { "@type": "Rating", "ratingValue": "5", "bestRating": "5" }, "author": { "@type": "Person", "name": "Tom B." }, "reviewBody": "Barcelona vs Real Madrid - El Clasico - best night of my life. Tickets were legit and cheap.", "datePublished": "2026-01-22" },
      { "@type": "Review", "reviewRating": { "@type": "Rating", "ratingValue": "4", "bestRating": "5" }, "author": { "@type": "Person", "name": "Priya S." }, "reviewBody": "Booked Coldplay at Camp Nou through EuroMatchTickets. Smooth process, instant delivery.", "datePublished": "2025-11-30" }
    ],
    ...
    <div className="min-h-screen bg-[hsl(210,20%,98%)]" data-testid="barcelona-hub-page">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-400 max-w-3xl mx-auto mb-8">Football matches + world-class concerts at the iconic Camp Nou. Barcelona is Europe's ultimate entertainment destination.</p>
      ...
      <section className="py-5 border-y border-slate-100 bg-slate-50">
        <div className="max-w-6xl mx-auto px-4 flex flex-wrap justify-center gap-8">
          ...
          <div className="flex items-center gap-2 text-emerald-600"><Star className="w-5 h-5" /><span>4.8/5 (4,156 Reviews)</span></div>
          <div className="flex items-center gap-2 text-emerald-600"><TrendingUp className="w-5 h-5" /><span>18,000+ Barcelona Tickets Sold</span></div>
        </div>
      </section>
