...
const TaylorSwiftPage = () => {
  ...
  const schema = {
    ...
    "offers": packages.map(p => ({ "@type": "Offer", "name": p.name, "priceCurrency": "EUR", "price": String(p.price), "availability": "https://schema.org/LimitedAvailability", "url": "https://euromatchtickets.com/taylor-swift-wembley-2026-tickets" }))
  };

  return (
    <div className="min-h-screen bg-[#0a0610]" data-testid="taylorswift-page">
      <SEOHead
        title="Taylor Swift Wembley 2026 Tickets – Cheapest Prices | Best Seats + Instant QR Delivery"
