...
const MyTicketsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 pt-20" data-testid="my-tickets-page">
        ...
        {orders.length === 0 ? (
          ...
          <Tabs defaultValue="upcoming" className="w-full">
            <TabsList className="mb-8 bg-zinc-900/50">
              <TabsTrigger value="upcoming" className="data-[state=active]:bg-zinc-800" data-testid="tab-upcoming">
                Upcoming ({upcomingOrders.length})
              </TabsTrigger>
              <TabsTrigger value="past" className="data-[state=active]:bg-zinc-800" data-testid="tab-past">
