...
const MotoGPMugelloPage = () => {
  const schema = {
    ...
    "offers": {
      "@type": "Offer",
      "url": "https://euromatchtickets.com/motogp-mugello-tickets",
      "price": "99",
      "priceCurrency": "EUR",
    ...
    <div className="min-h-screen bg-[#0e0e14]">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          <Badge className="bg-green-500/100/20 text-green-600 border-green-500/30 mb-6">
            <Bike className="w-4 h-4 mr-2" />The Cathedral of Motorcycling 🏍️
          </Badge>
          
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Italian MotoGP 2026 Tickets
            <span className="block text-2xl md:text-3xl mt-2 text-slate-500">Mugello Circuit • Tuscany, Italy 🇮🇹</span>
          </h1>
          ...
          <p className="text-xl text-slate-500 max-w-3xl mx-auto mb-8">
            ...
            and legendary circuit. <strong className="text-emerald-600">Tickets from €79!</strong>
          </p>

          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <div className="flex items-center gap-2 px-4 py-2 bg-[#15151e] rounded-full">
              <Calendar className="w-5 h-5 text-green-600" /><span>June 12-14, 2026</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-[#15151e] rounded-full">
              <MapPin className="w-5 h-5 text-green-600" /><span>Mugello, Italy</span>
            </div>
          </div>
          ...
          <div className="inline-block bg-white/90 border border-emerald-200 rounded-none p-6">
            ...
            <div className="text-5xl font-bold text-emerald-600">€79</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-6 border-y border-white/5 bg-[#15151e]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="flex items-center gap-2 justify-center text-emerald-600"><Shield className="w-5 h-5" /><span className="text-sm">Buyer protection</span></div>
              ...
              <div key={i} className="flex flex-col md:flex-row md:items-center justify-between bg-[#1e1e1e] border border-white/5 hover:border-green-500/30 rounded-none p-6 transition-all">
                <div className="flex items-center gap-4 mb-4 md:mb-0">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Italian MotoGP 2026 • 3-Day Pass</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <Link to="/checkout?event=motogp-mugello-2026"><Button className="bg-green-500/100 hover:bg-green-600">View</Button></Link>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-[#15151e]">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8 flex items-center gap-2"><HelpCircle className="w-6 h-6 text-green-600" />Mugello MotoGP FAQ</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-green-900/30 to-red-900/30">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-500 mb-8">The most passionate MotoGP atmosphere awaits</p>
          <Link to="/motogp-tickets">
            <Button size="lg" className="bg-green-500/100 hover:bg-green-600 px-8">
