  ...
  return (
    <div className="min-h-screen bg-[#0e0e14]">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-12">
        {/* Main Guarantee Box */}
        <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-200 rounded-3xl p-8 mb-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-slate-500 text-sm">Event cancelled without reschedule? Full refund.</p>
            </div>
          </div>
        </div>
            ...
            <ol className="space-y-4">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-sm">Report the issue within 48 hours of the event date.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="w-8 h-8 bg-cyan-500/20 rounded-full flex items-center justify-center text-cyan-600 font-bold flex-shrink-0">2</span>
                <div>
                  <p className="font-semibold">Provide Evidence</p>
                  <p className="text-slate-500 text-sm">Share your order number and any relevant proof (screenshots, venue rejection notice, etc.)</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="w-8 h-8 bg-cyan-500/20 rounded-full flex items-center justify-center text-cyan-600 font-bold flex-shrink-0">3</span>
                <div>
                  <p className="font-semibold">Review Process</p>
                  <p className="text-slate-500 text-sm">Our team reviews your claim within 3-5 business days.</p>
                </div>
              </li>
              <li className="flex gap-4">
                <span className="w-8 h-8 bg-cyan-500/20 rounded-full flex items-center justify-center text-cyan-600 font-bold flex-shrink-0">4</span>
                <div>
                  <p className="font-semibold">Refund Processed</p>
                  <p className="text-slate-500 text-sm">If approved, refund is issued to your original payment method within 5-10 business days.</p>
                </div>
              </li>
            </ol>
          </div>
