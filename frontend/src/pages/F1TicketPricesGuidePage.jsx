    ...
    <div className="min-h-screen bg-zinc-950 pt-20">
      ...
      <section className="relative py-16 bg-gradient-to-br from-emerald-600/20 via-zinc-900 to-zinc-950">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <span className="block text-2xl mt-2 text-zinc-400">Complete Price Guide for All Races</span>
          </h1>
      ...
      <section className="py-8 border-y border-white/5 bg-zinc-900/30">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <div className="text-sm text-zinc-500 mb-1">General Admission</div>
              <div className="text-2xl font-bold text-emerald-400">€99 - €289</div>
            </div>
            <div>
              <div className="text-sm text-zinc-500 mb-1">Grandstand</div>
              <div className="text-2xl font-bold text-blue-400">€189 - €589</div>
            </div>
            <div>
              <div className="text-sm text-zinc-500 mb-1">VIP Hospitality</div>
              <div className="text-2xl font-bold text-purple-400">€889 - €1,989</div>
            </div>
            <div>
              <div className="text-sm text-zinc-500 mb-1">Paddock Club</div>
              <div className="text-2xl font-bold text-amber-400">€2,689 - €5,989</div>
            </div>
          </div>
        </div>
      </section>
              ...
              <tbody>
                {priceData.sort((a, b) => a.ga - b.ga).map((race, i) => (
                  <tr key={i} className="border-b border-zinc-800 hover:bg-zinc-900/30">
                    ...
                    <td className="py-3 px-4 text-right text-emerald-400">€{race.ga}</td>
                    <td className="py-3 px-4 text-right text-blue-400">€{race.grandstand}</td>
                    <td className="py-3 px-4 text-right text-purple-400">€{race.vip}</td>
                    <td className="py-3 px-4 text-right text-amber-400">€{race.paddock}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          </div>
          <p className="text-zinc-500 text-sm mt-4">* Prices are starting prices for 3-day weekend passes. Actual prices may vary based on grandstand selection and availability.</p>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-3">
                {cheapestRaces.map((race, i) => (
                  <div key={i} className="flex items-center justify-between bg-zinc-900/50 rounded-lg p-4">
                    <span className="font-medium">{i + 1}. {race.race}</span>
                    <span className="text-emerald-400 font-bold">from €{race.ga}</span>
                  </div>
                ))}
              </div>
            </div>
            <div>
              ...
              <div className="space-y-3">
                {mostExpensive.map((race, i) => (
                  <div key={i} className="flex items-center justify-between bg-zinc-900/50 rounded-lg p-4">
                    <span className="font-medium">{i + 1}. {race.race}</span>
                    <span className="text-amber-400 font-bold">from €{race.ga}</span>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-bold text-emerald-400 mb-2">General Admission (€99 - €289)</h3>
              <p className="text-zinc-400">Access to designated viewing areas around the circuit. No reserved seat - arrive early for best spots. Great value for exploring multiple vantage points throughout the weekend.</p>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-bold text-blue-400 mb-2">Grandstand (€189 - €589)</h3>
              <p className="text-zinc-400">Reserved numbered seat in covered or uncovered grandstand. Choose specific corners like Turn 1, Pit Straight, or iconic locations like Eau Rouge (Spa) or Casino (Monaco).</p>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-bold text-purple-400 mb-2">VIP Hospitality (€889 - €1,989)</h3>
              <p className="text-zinc-400">Premium experience including grandstand seat plus hospitality suite access. Includes gourmet food, open bar, pit lane walks, and sometimes driver appearances.</p>
            </div>
            <div className="bg-zinc-900/50 border border-zinc-700 rounded-xl p-6">
              <h3 className="text-xl font-bold text-amber-400 mb-2">Paddock Club (€2,689 - €5,989)</h3>
              <p className="text-zinc-400">The ultimate F1 experience. Exclusive paddock access, five-star dining, open champagne bar, behind-the-scenes tours, and the chance to meet drivers and team principals.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 bg-zinc-900/50 rounded-lg p-4">
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-900/30 to-blue-900/30">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-zinc-400 mb-8">Browse all races and find tickets at the best prices</p>
          <Link to="/f1-tickets">
