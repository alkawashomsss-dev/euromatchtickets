...
const BadBunnyPage = () => {
  const schema = {
    ...
    "offers": { "@type": "AggregateOffer", "priceCurrency": "EUR",
              "offerCount": "100", "lowPrice": "145", "highPrice": "600", "availability": "https://schema.org/InStock", "url": "https://euromatchtickets.com/bad-bunny-london-2026", "validFrom": "2025-01-01" }
  };
  ...
  return (
    <div className="min-h-screen bg-[#0e0e14]">
      ...
      <BreadcrumbSchema items={[{ name: "Home", url: "https://euromatchtickets.com/" }, { name: "Concerts", url: "https://euromatchtickets.com/events?type=concert" }, { name: "Bad Bunny London 2026", url: "https://euromatchtickets.com/bad-bunny-london-2026" }]} />
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-violet-50 border border-violet-200 rounded-full px-4 py-2 mb-6 animate-pulse">
            ...
            <span className="text-violet-600 font-medium">2 NIGHTS ONLY - London Stadium!</span>
          </div>
          <Badge className="bg-pink-500/20 text-pink-600 border-pink-500/30 mb-6">
      ...
      <section className="py-6 border-y border-white/5 bg-[#15151e]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex items-center gap-2 text-emerald-600"><TrendingUp className="w-5 h-5" /><span>8,200+ Sold</span></div>
          </div>
        </div>
      </section>
