    ...
    return (
      <div className="min-h-screen bg-[#0e0e14]">
        <div className="max-w-2xl mx-auto px-4 py-20 text-center">
          <div className="w-20 h-20 rounded-none bg-violet-50 flex items-center justify-center mx-auto mb-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <Dialog open={showAddTicket} onOpenChange={setShowAddTicket}>
              ...
              <DialogContent className="bg-[#1e1e1e] border-white/10 max-w-md">
                <DialogHeader>
            ...
            {loading ? (
              ...
              <div className="space-y-4">
                {availableTickets.map(ticket => {
                  ...
                  return (
                    <div key={ticket.ticket_id} className="bg-[#1e1e1e] border border-white/5 rounded-none p-4 flex items-center justify-between">
                      <div className="flex items-center gap-4">
            ...
            {soldTickets.length === 0 ? (
              ...
              <div className="space-y-4">
                {soldTickets.map(ticket => (
                  <div key={ticket.ticket_id} className="bg-[#1e1e1e] border border-white/5 rounded-none p-4 flex items-center justify-between opacity-60">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-none bg-slate-100 flex items-center justify-center">
                    ...
                    <div className="text-right">
                      <div className="text-xl font-bold">€{ticket.price}</div>
                      <Badge variant="outline" className="border-white/15 text-slate-500 text-xs">
                        Sold
                      </Badge>
                    </div>
                  </div>
