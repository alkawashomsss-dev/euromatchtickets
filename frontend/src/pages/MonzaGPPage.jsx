  ...
  return (
    <div className="min-h-screen bg-[#0e0e14]" data-testid="monza-gp-page">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-1 w-1 h-full bg-[#1e1e1e]" />
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3 mb-8">
                <span className="flex items-center gap-2 text-sm text-slate-400 bg-[#1e1e1e] rounded-full px-4 py-2 shadow-sm">
            ...
            <div className="w-full lg:w-auto">
              <div className="bg-[#1e1e1e] rounded-none shadow-xl border border-white/5 p-6 space-y-4 min-w-[280px]">
                <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider">MONZA STATS</h3>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-400">Circuit Length</span>
                    <span className="font-bold text-white">5.793 km</span>
                  </div>
                  <div className="h-px bg-slate-100" />
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-400">Top Speed</span>
                    <span className="font-bold text-red-600">365 km/h</span>
                  </div>
                  <div className="h-px bg-slate-100" />
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-400">First Race</span>
                    <span className="font-bold text-white">1950</span>
                  </div>
                  <div className="h-px bg-slate-100" />
                  <div className="flex justify-between items-center">
                    <span className="text-sm text-slate-400">Our Price</span>
      ...
      <section id="tickets" className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-white mb-2">Monza F1 2026 Tickets</h2>
          <p className="text-slate-500 mb-8">The cheapest F1 race in Europe - from just &euro;69!</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {tickets.map((t, i) => (
              <div key={i} className={`bg-[#1e1e1e] border-2 ${t.color || 'border-white/5'} rounded-none p-6 hover:shadow-lg transition-all relative overflow-hidden`} data-testid={`monza-ticket-${i}`}>
                {t.badge && (
                ...
                <h3 className="font-bold text-white text-lg mb-1">{t.section}</h3>
                ...
                <div className="flex items-center justify-between mt-auto pt-3 border-t border-white/5">
                  <div>
                    ...
                    <span className="text-2xl font-black text-white ml-2">&euro;{t.price}</span>
                  </div>
      ...
      <section className="py-16 bg-gradient-to-br from-red-50 to-green-50">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#1e1e1e] rounded-none p-6 shadow-sm">
              <h3 className="font-bold text-red-600 mb-2">Track Invasion</h3>
              <p className="text-slate-400 text-sm">When a Ferrari wins at Monza, 100,000+ Tifosi fans storm the track in a wave of red. It's the most emotional moment in all of motorsport. The atmosphere is absolutely electric from Friday practice to Sunday's podium ceremony.</p>
            </div>
            <div className="bg-[#1e1e1e] rounded-none p-6 shadow-sm">
              <h3 className="font-bold text-green-600 mb-2">Italian Food Paradise</h3>
              <p className="text-slate-400 text-sm">Monza isn't just racing - it's a culinary festival. Fresh pasta, pizza, gelato, and espresso from local Italian vendors line the Parco di Monza. Many fans bring their own picnic. Pro tip: try the arancini near Gate 1!</p>
            </div>
            <div className="bg-[#1e1e1e] rounded-none p-6 shadow-sm">
              <h3 className="font-bold text-red-600 mb-2">Best Value in F1</h3>
              <p className="text-slate-400 text-sm">At just &euro;69 for General Admission, Monza is the cheapest race on the entire F1 calendar. Combine with budget flights from anywhere in Europe, and you've got the best F1 experience for under &euro;200 total. Unbeatable value.</p>
            </div>
            <div className="bg-[#1e1e1e] rounded-none p-6 shadow-sm">
              <h3 className="font-bold text-green-600 mb-2">Milan Weekend</h3>
              <p className="text-slate-400 text-sm">Just 15km from Milan, combine your Monza GP weekend with world-class shopping, Da Vinci's Last Supper, AC Milan at San Siro, and Italy's fashion capital nightlife. It's the perfect European weekend.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#15151e]">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-white mb-6">Frequently Asked Questions - Monza GP</h2>
      ...
      <section className="py-12 bg-[#e10600]/10">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-lg font-bold text-white mb-4">Complete Monza F1 Guide</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
            <Link to="/monza-best-seats-guide" className="bg-[#1e1e1e] border border-white/10 rounded-none p-4 hover:border-red-300 hover:shadow-md transition-all">
              <p className="font-bold text-white text-sm">Best Seats Guide</p>
              <p className="text-xs text-slate-500 mt-1">Every grandstand rated by experts</p>
            </Link>
            <Link to="/monza-ticket-prices" className="bg-[#1e1e1e] border border-white/10 rounded-none p-4 hover:border-red-300 hover:shadow-md transition-all">
              <p className="font-bold text-white text-sm">Ticket Prices Compared</p>
              <p className="text-xs text-slate-500 mt-1">Save up to 40% vs competitors</p>
            </Link>
            <Link to="/how-to-get-to-monza" className="bg-[#1e1e1e] border border-white/10 rounded-none p-4 hover:border-red-300 hover:shadow-md transition-all">
              <p className="font-bold text-white text-sm">How to Get There</p>
              <p className="text-xs text-slate-500 mt-1">From Milan in 45 minutes</p>
            </Link>
            <Link to="/monza-f1-travel-tips" className="bg-[#1e1e1e] border border-white/10 rounded-none p-4 hover:border-red-300 hover:shadow-md transition-all">
              <p className="font-bold text-white text-sm">Tips & Travel Guide</p>
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-lg font-bold text-white mb-4">Explore More Events</h2>
