      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid gap-4">
            {shows.map((show, i) => (
              <Link key={i} to="/checkout?event=the-weeknd-2026" className="group flex flex-col md:flex-row md:items-center justify-between bg-[#1e1e1e] border border-white/5 hover:border-red-200 rounded-none p-6 transition-all">
