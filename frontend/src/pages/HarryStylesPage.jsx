      ...
      <section className="py-12 bg-gradient-to-r from-amber-900/20 via-slate-900 to-amber-900/20">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="bg-gradient-to-br from-amber-900/30 to-slate-900/50 border border-amber-500/50 rounded-none p-6 text-center">
            ...
            <div className="bg-gradient-to-br from-purple-900/30 to-slate-900/50 border border-purple-500/50 rounded-none p-6 text-center">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {events.map((event) => (
                <Link key={event.event_id} to={`/event/${event.slug || event.event_id}`} className="block bg-[#1e1e1e] border border-white/10 hover:border-pink-500/50 rounded-none p-6 transition-all group">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 rounded-none bg-gradient-to-br from-pink-600 to-purple-600 flex items-center justify-center">
                        <Music className="w-8 h-8 text-white" />
                      </div>
                      <div>
                        <div className="flex items-center gap-2">
                          <h3 className="text-xl font-bold group-hover:text-pink-600 transition-colors">{event.title}</h3>
                          {event.title.includes('VIP') && <Badge className="bg-amber-500/100 text-white">VIP</Badge>}
                        </div>
