        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid gap-4">
            {tickets.map((ticket, i) => (
              <div key={i} className="flex flex-col md:flex-row md:items-center justify-between bg-white border border-slate-100 hover:border-cyan-500/30 rounded-2xl p-6 transition-all">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-2">
            {["Miami GP tickets", "F1 Miami 2026", "Miami Grand Prix tickets", "Miami F1 tickets", "buy Miami GP tickets", "Miami F1 hospitality", "Miami GP grandstand", "F1 Miami beach grandstand", "Miami International Autodrome tickets", "F1 USA tickets 2026"].map((term, i) => (
              <span key={i} className="px-3 py-1 bg-slate-50 text-slate-500 rounded-full text-sm hover:bg-slate-100 cursor-pointer">{term}</span>
            ))}
          </div>
        </div>
      </section>
