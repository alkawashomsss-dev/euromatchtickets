        ...
        <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex gap-4">
                <div className="text-center">
                  ...
                  <div className="text-xs text-slate-500">Pages Indexed</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">4</div>
                  <div className="text-xs text-slate-500">Search Engines</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">Submit & monitor</div>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">IndexNow supported</div>
                </div>
                <ExternalLink className="w-4 h-4 text-slate-400 ml-auto" />
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">sitemap.xml</div>
                </div>
                <ExternalLink className="w-4 h-4 text-slate-400 ml-auto" />
              </a>
            </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl p-6 border border-purple-500/20">
            ...
            <ol className="space-y-3 text-slate-600">
              ...
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 bg-violet-50 rounded-full flex items-center justify-center text-sm font-bold text-violet-600">2</span>
                <span><strong>Ping Regularly:</strong> Click "Ping Search Engines" after adding new events or pages</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 bg-violet-50 rounded-full flex items-center justify-center text-sm font-bold text-violet-600">3</span>
                <span><strong>Use IndexNow:</strong> Submit URLs for instant indexing on Bing (which shares with others)</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 bg-violet-50 rounded-full flex items-center justify-center text-sm font-bold text-violet-600">4</span>
                <span><strong>Share Content:</strong> Use the Marketing Bot to create viral social posts that bring traffic</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="w-6 h-6 bg-violet-50 rounded-full flex items-center justify-center text-sm font-bold text-violet-600">5</span>
