...
const HungaryGPPage = () => {
  const schema = {
    ...
    "offers": {
      "@type": "Offer",
      "url": "https://euromatchtickets.com/f1-hungarian-grand-prix-tickets",
      "price": "99",
      "priceCurrency": "EUR",
            ...
            {tickets.map((ticket, i) => (
              <div key={i} className="flex flex-col md:flex-row md:items-center justify-between bg-[#1e1e1e] border border-white/5 hover:border-red-200 rounded-none p-6 transition-all">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Link to="/checkout?event=hungary-grand-prix-2026"><Button className="bg-[#e10600]/100 hover:bg-red-600">View</Button></Link>
                </div>
              </div>
            ))}
          </div>
