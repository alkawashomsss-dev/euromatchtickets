...
const BrunoMarsPage = () => {
  const schema = {
    ...
    "offers": { "@type": "AggregateOffer", "priceCurrency": "EUR",
              "offerCount": "100", "lowPrice": "125", "highPrice": "650", "availability": "https://schema.org/InStock", "url": "https://euromatchtickets.com/bruno-mars-tour-2026", "validFrom": "2025-01-01" }
  };
  ...
  return (
    <div className="min-h-screen bg-[#0e0e14]">
      ...
      <BreadcrumbSchema items={[{ name: "Home", url: "https://euromatchtickets.com/" }, { name: "Concerts", url: "https://euromatchtickets.com/events?type=concert" }, { name: "Bruno Mars Tour 2026", url: "https://euromatchtickets.com/bruno-mars-tour-2026" }]} />
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <div className="flex items-center gap-2 px-4 py-2 bg-[#15151e] rounded-full"><Calendar className="w-5 h-5 text-violet-600" /><span>June - July 2026</span></div>
            <div className="flex items-center gap-2 px-4 py-2 bg-[#15151e] rounded-full"><MapPin className="w-5 h-5 text-violet-600" /><span>6 Cities, 18 Shows</span></div>
            <div className="flex items-center gap-2 px-4 py-2 bg-[#15151e] rounded-full"><Users className="w-5 h-5 text-violet-600" /><span>Stadium Tour</span></div>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid gap-4">
            {shows.map((show, i) => (
              <Link key={i} to="/checkout?event=bruno-mars-2026" className="group flex flex-col md:flex-row md:items-center justify-between bg-[#1e1e1e] border border-white/5 hover:border-violet-200 rounded-none p-6 transition-all">
                <div className="flex items-center gap-4 mb-4 md:mb-0">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {show.hot && <Badge className="bg-[#e10600]/10 text-red-600 text-xs animate-pulse">HIGH DEMAND</Badge>}
                    </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Button className="bg-purple-500/100 hover:bg-purple-600 text-black font-bold">Buy Tickets</Button>
                </div>
              </Link>
            ))}
          </div>
