...
const WorldCupPage = () => {
  ...
  const worldCupSchema = {
    ...
    "offers": {
      "@type": "Offer",
      "url": "https://euromatchtickets.com/fifa-world-cup-tickets",
      "price": "65",
      "priceCurrency": "EUR",
    ...
    <div className="min-h-screen bg-[#0a0e1a]" data-testid="worldcup-page">
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-slate-400 mb-8 max-w-lg mx-auto">Tickets are. Secure your seats for the FIFA World Cup 2026.</p>
