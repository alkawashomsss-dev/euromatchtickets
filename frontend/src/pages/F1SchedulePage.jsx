...
const F1SchedulePage = () => {
  const schema = {
    ...
    "numberOfItems": 24,
    "itemListElement": [
      { "@type": "SportsEvent", "position": 1, "name": "Bahrain Grand Prix", "description": "Formula 1 Bahrain Grand Prix 2026 at Bahrain International Circuit. Buy tickets now.", "startDate": "2026-03-08", "endDate": "2026-03-09", "eventStatus": "https://schema.org/EventScheduled", "image": "https://euromatchtickets.com/logo.png", "location": {"@type": "Place", "name": "Bahrain International Circuit", "address": {"@type": "PostalAddress", "addressLocality": "Sakhir", "addressCountry": "BH"}}, "performer": {"@type": "SportsTeam", "name": "Formula 1 - FIA"},
    "organizer": {"@type": "Organization", "name": "EuroMatchTickets", "url": "https://euromatchtickets.com"}, "offers": {"@type": "AggregateOffer", "lowPrice": "149", "highPrice": "2499", "priceCurrency": "EUR", "availability": "https://schema.org/InStock", "url": "https://euromatchtickets.com/f1-bahrain-grand-prix-tickets", "validFrom": "2025-01-01"} },
      { "@type": "SportsEvent", "position": 2, "name": "Saudi Arabian Grand Prix", "description": "Formula 1 Saudi Arabian Grand Prix 2026 at Jeddah Corniche Circuit. Buy tickets now.", "startDate": "2026-03-22", "endDate": "2026-03-23", "eventStatus": "https://schema.org/EventScheduled", "image": "https://euromatchtickets.com/logo.png", "location": {"@type": "Place", "name": "Jeddah Corniche Circuit", "address": {"@type": "PostalAddress", "addressLocality": "Jeddah", "addressCountry": "SA"}}, "performer": {"@type": "SportsTeam", "name": "Formula 1 - FIA"},
    "organizer": {"@type": "Organization", "name": "EuroMatchTickets", "url": "https://euromatchtickets.com"}, "offers": {"@type": "AggregateOffer", "lowPrice": "169", "highPrice": "2999", "priceCurrency": "EUR", "availability": "https://schema.org/InStock", "url": "https://euromatchtickets.com/f1-saudi-arabian-grand-prix-jeddah-tickets", "validFrom": "2025-01-01"} },
      { "@type": "SportsEvent", "position": 3, "name": "Australian Grand Prix", "description": "Formula 1 Australian Grand Prix 2026 at Albert Park Circuit, Melbourne. Buy tickets now.", "startDate": "2026-03-15", "endDate": "2026-03-16", "eventStatus": "https://schema.org/EventScheduled", "image": "https://euromatchtickets.com/logo.png", "location": {"@type": "Place", "name": "Albert Park Circuit", "address": {"@type": "PostalAddress", "addressLocality": "Melbourne", "addressCountry": "AU"}}, "performer": {"@type": "SportsTeam", "name": "Formula 1 - FIA"},
    "organizer": {"@type": "Organization", "name": "EuroMatchTickets", "url": "https://euromatchtickets.com"}, "offers": {"@type": "AggregateOffer", "lowPrice": "159", "highPrice": "2499", "priceCurrency": "EUR", "availability": "https://schema.org/InStock", "url": "https://euromatchtickets.com/f1-australian-grand-prix-melbourne-tickets", "validFrom": "2025-01-01"} },
    ]
  };
  ...
  const races = [
    ...
    { round: 5, name: "Chinese Grand Prix", location: "Shanghai, China", circuit: "Shanghai International Circuit", date: "April 17-19", price: 149, href: "/events?type=f1", night: false, featured: false },
    ...
    { round: 7, name: "Emilia Romagna Grand Prix", location: "Imola, Italy", circuit: "Autodromo Enzo e Dino Ferrari", date: "May 15-17", price: 129, href: "/events?type=f1", night: false, featured: false },
    ...
    { round: 10, name: "Canadian Grand Prix", location: "Montreal, Canada", circuit: "Circuit Gilles Villeneuve", date: "June 12-14", price: 179, href: "/events?type=f1", night: false, featured: true },
    ...
    { round: 17, name: "Azerbaijan Grand Prix", location: "Baku, Azerbaijan", circuit: "Baku City Circuit", date: "Sept 18-20", price: 159, href: "/events?type=f1", night: false, featured: false },
    ...
    { round: 19, name: "United States Grand Prix", location: "Austin, USA", circuit: "Circuit of the Americas", date: "Oct 23-25", price: 179, href: "/events?type=f1", night: false, featured: true },
    { round: 20, name: "Mexico City Grand Prix", location: "Mexico City, Mexico", circuit: "Autódromo Hermanos Rodríguez", date: "Oct 30-Nov 1", price: 149, href: "/events?type=f1", night: false, featured: false },
    { round: 21, name: "São Paulo Grand Prix", location: "São Paulo, Brazil", circuit: "Interlagos", date: "Nov 13-15", price: 159, href: "/events?type=f1", night: false, featured: true },
    ...
    { round: 23, name: "Qatar Grand Prix", location: "Lusail, Qatar", circuit: "Lusail International Circuit", date: "Nov 27-29", price: 169, href: "/events?type=f1", night: true, featured: false },
  ...
  return (
    <div className="min-h-screen bg-[hsl(210,20%,98%)]">
      <SEOHead 
        ...
        description="Complete F1 2026 race schedule with all 24 Grand Prix dates, locations, and tickets. Monaco, Silverstone, Monza, Singapore, Las Vegas. Buy F1 tickets from."
      />
