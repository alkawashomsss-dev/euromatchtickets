...
const ManCityHubPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[hsl(210,20%,98%)]" data-testid="man-city-hub-page">
      <SEOHead
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-slate-50 rounded-full"><Users className="w-5 h-5 text-sky-600" /><span>53,400 Capacity</span></div>
          </div>
      ...
      <section className="py-16" data-testid="mc-matches">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center text-slate-900">Manchester City Matches 2026</h2>
          <div className="grid gap-4">
            {matches.map((m, i) => (
              <Link key={i} to={m.link} className="group flex flex-col md:flex-row md:items-center justify-between bg-white border border-slate-100 hover:border-sky-200 rounded-2xl p-6 transition-all" data-testid={`mc-match-${i}`}>
                <div className="flex items-center gap-4 mb-4 md:mb-0">
                  <div className="w-14 h-14 bg-sky-50 rounded-xl flex items-center justify-center"><Trophy className="w-7 h-7 text-sky-600" /></div>
                  <div>
                    <div className="flex items-center gap-2">
                      <h3 className="font-bold text-slate-900 group-hover:text-sky-600">{m.home} vs {m.away}</h3>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold mb-6 text-slate-900">Buy Manchester City Tickets 2025-26</h2>
      ...
      {/* LINK WHEEL */}
      <section className="py-16 bg-slate-50" data-testid="mc-link-hub">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8 text-center text-slate-900">More Events on EuroMatchTickets</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl p-5 border border-slate-100">
              <h3 className="font-bold text-slate-900 mb-3 flex items-center gap-2"><Trophy className="w-5 h-5 text-sky-600" /> Man City</h3>
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-100">
              <h3 className="font-bold text-slate-900 mb-3 flex items-center gap-2"><Globe className="w-5 h-5 text-emerald-500" /> Premier League</h3>
              <ul className="space-y-2">
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-100">
              <h3 className="font-bold text-slate-900 mb-3 flex items-center gap-2"><Zap className="w-5 h-5 text-red-500" /> More</h3>
              <ul className="space-y-2">
      ...
      <section className="py-16" data-testid="mc-faq">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-bold mb-8 text-center text-slate-900">Manchester City Tickets FAQ</h2>
      ...
      <section className="py-16 bg-gradient-to-br from-sky-600 to-sky-800">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/events?type=match"><Button className="bg-white text-sky-700 hover:bg-sky-50 text-lg px-8 py-3">Browse Matches</Button></Link>
